...
if Checks.CheckIfFolderFuncs then
	if not isfolder("Frost-Admin-V2") then
		makefolder("Frost-Admin-V2")
	end

	if not isfolder("Frost-Admin-V2/Plugins") then
		makefolder("Frost-Admin-V2/Plugins")
	end

	if not isfolder("Frost-Admin-V2/Waypoints") then
		makefolder("Frost-Admin-V2/Waypoints")
	end

	if not isfolder("Frost-Admin-V2/KeyBinds") then
		makefolder("Frost-Admin-V2/KeyBinds")
	end
end
...
local Interface
Interface = game:GetObjects("rbxassetid://79101142110955")[1]
...
Command.Add(
	...
	function()
		...
		UIFuncs.SendNotification("Frostware Admin", "Successfully unlocked every part in the game", 5)
	end
)
...
Command.Add(
	...
	function()
		...
		UIFuncs.SendNotification("Frostware Admin", "Anti kick loaded", 5)
	end
)
...
Command.Add(
	...
	function()
		...
		UIFuncs.SendNotification("Frostware Admin", "Anti teleport loaded", 5)
	end
)
...
Command.Add(
	...
	function()
		...
		if Tool.Parent ~= workspace then
			...
			UIFuncs.SendNotification("Frostware Admin", "No tool grabber was found", 5)
		end
...
Command.Add(
	...
	function(Username)
		if not Services.SoundService.RespectFilteringEnabled then
			...
			UIFuncs.SendNotification('Frostware Admin', 'Respect Filtering Enabled is on, so this command wont work.', 5)
		end
	end
)
...
Command.Add(
	...
	function(Property, Value)
		if Property and Value then
			...
			UIFuncs.SendNotification("Frostware Admin", "Missing an argument", 5)
		end
	end
)
...
Command.Add(
	...
	function()
				...
				Plr.Chatted:Connect(
					function(Message)
						if CheckIfMessageHasBannedWord(Message) then
							...
							UIFuncs.SendNotification("Frostware Admin", "Reported " .. Plr.Name .. " for " .. Reason, 5)
		...
		UIFuncs.SendNotification("Frostware Admin", "Auto report has loaded!", 5)
	end
)
...
Command.Add(
	...
	function()
		...
		if fireclickdetector then
			...
			UIFuncs.SendNotification("Frostware Admin", "Fired " .. tostring(Amount) .. " click detectors", 5)
		else
			UIFuncs.SendNotification("Frostware Admin", "Your exploit doesnt support this command", 5)
		end
	end
)
...
Command.Add(
	...
	function()
		...
		UIFuncs.SendNotification("Frostware Admin", "Antifling <b>enabled</b>", 5)
		repeat
			task.wait()
...
Command.Add(
	...
	function()
		...
		if firetouchinterest then
			...
			UIFuncs.SendNotification("Frostware Admin", "Fired " .. tostring(Amount) .. " touch interests", 5)
		else
			UIFuncs.SendNotification("Frostware Admin", "Your exploit doesnt support this command", 5)
		end
	end
...
Command.Add(
	...
	function()
		...
		if fireproximityprompt then
			...
			UIFuncs.SendNotification("Frostware Admin", "Fired " .. tostring(Amount) .. " proximity prompts", 5)
		else
			UIFuncs.SendNotification("Frostware Admin", "Your exploit doesnt support this command", 5)
		end
	end
...
Command.Add(
	...
	function()
		...
		UIFuncs.SendNotification("Frostware Admin", "Fired " .. tostring(Amount) .. " remotes", 5)
	end
)
...
Command.Add(
	...
	function(Gravity)
		...
		UIFuncs.SendNotification("Frostware Admin", "Set gravity for unanchored parts to " .. tostring(Gravity), 5)
	end
)
...
Command.Add(
	...
	function(...)
		for i, Player in next, PlayerFuncs.GetPlayer(...) do
			if Player.Character and Player.Character.Humanoid then
				UIFuncs.SendNotification("Frostware Admin", "Viewing @" .. Player.Name, 5)
...
Command.Add(
	{"Prefix", "Pre"},
	{"Prefix / Pre", "Changes the prefix of Frostware"},
	{"Prefix"},
	function(Prefix)
...
Command.Add(
	...
	function(Power)
		...
		UIFuncs.SendNotification("Frostware Admin", "Touchfling <b>enabled</b>", 5)
...
Command.Add(
	...
	{"None"},
	function()
		UIFuncs.SendNotification("Frostware Admin", "Touchfling <b>disabled</b>", 5)
...
Command.Add(
	...
	{"None"},
	function()
		UIFuncs.SendNotification("Frostware Admin", "Dropping all tools in your inventory", 5)
...
Command.Add(
	...
	{"None"},
	function()
		UIFuncs.SendNotification("Frostware Admin", "Started grabbing & deleting tools", 5)
...
Command.Add(
	...
	{"None"},
	function()
		UIFuncs.SendNotification("Frostware Admin", "Stopped grabbing & deleting tools", 5)
		CommandToggles.LoopGrabDelete = false
	end
)
...
Command.Add(
	...
	{"None"},
	function()
		UIFuncs.SendNotification("Frostware Admin", "Started grabbing tools", 5)
...
Command.Add(
	...
	{"None"},
	function()
		UIFuncs.SendNotification("Frostware Admin", "Stopped grabbing tools", 5)
		CommandToggles.LoopGrab = false
	end
)
...
Command.Add(
	{"CommandCount", "CC"},
	{"CommandCount / CC", "Tells the amount of commands Frostware has"},
	{"None"},
	function()
		UIFuncs.SendNotification("Frostware Admin", tostring(CommandAmount), 5)
	end
)
...
Command.Add(
	{"Admin", "A"},
	{"Admin / A", "Gives another user access to use Frostware Admin commands without having it ran"},
	{"Username"},
	function(Username)
		...
		for i, Plr in next, Player do
			if not Settings.Admins[Plr.UserId] then
				...
				UIFuncs.SendNotification("Frostware Admin", "Succcessfully gave <b>" .. Plr.Name .. "</b> admin!", 5)
				PlayerFuncs.Chat("/w " .. Plr.Name .. " [FW] You are now an admin")
			else
				UIFuncs.SendNotification("Frostware Admin", "This user seems to already be an admin", 5)
			end
		end
	end
)
	...
	function(Username)
		...
		for i, Plr in next, Player do
			if Settings.Admins[Plr.UserId] then
				...
				UIFuncs.SendNotification("Frostware Admin", "Succcessfully removed <b>" .. Plr.Name .. "'s</b> admin", 5)
				PlayerFuncs.Chat("/w " .. Plr.Name .. " [FW] You are no longer an admin")
			else
				UIFuncs.SendNotification("Frostware Admin", "The user <b>" .. Plr.Name .. "</b> isn't an admin", 5)
			end
		end
	end
)
...
Command.Add(
	{"Introduction", "Int"},
	{"Introduction / Int", "An introduction to Frostware Admin if you haven't read it yet"},
	{"None"},
	function()
		wait(0.3)
...
Command.Add(
	...
	function()
		...
		if CommandToggles.AlreadyStartedLogging == false then
			...
			UIFuncs.SendNotification("Frostware Admin", "Started logging", 5)
			for i, Player in next, Services.Players:GetPlayers() do
				if Services.TextChatService:FindFirstChild("TextChannels") then
...
Command.Add(
	...
	{"Settings / Options / Set / Opt", "Opens the Options tab, allows you to change things about Frostware"},
	{"None"},
	function()
		local Popup = UIFuncs
...
if Methods.CheckIfVulnerable() then
	...
	UIFuncs.SendNotification(
		"Frostware Admin",
		"Seems like this game has an remote that is vulnerable to attacks using Frostware, you have been given extra commands run <b>cmds</b> and look for commands that have '(Vuln)' next to them, to see what new commands you now have.",
		15
	)
...
UIFuncs.SendNotification("Frostware Admin", "Frostware Admin has loaded", 5)
...
UIFuncs.PopupTrigger(
	"Frostware Admin",
	"Seems like you are new here, would you like a tutorial on how to use FW Admin?",
	function()
		wait(0.3)
		UIFuncs.Open(Interface.Introduction, 317, 283, 0.6)
		Interface.Introduction.Description.TextTransparency = 1
